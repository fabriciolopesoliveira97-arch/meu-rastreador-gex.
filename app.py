...
# --- LINHA DO PREÇO SPOT (Destaque Máximo) ---
fig_hist.add_vline(
    x=current_price, 
    line_dash="solid", 
    line_color="yellow", 
    line_width=3,
    layer="above" # Garante que a linha fique na frente das barras
)

# Cálculo dinâmico para posicionar o texto do Spot no topo do gráfico
...
fig_hist.update_layout(
    ...
    # Centraliza o zoom no preço atual (3% para cada lado)

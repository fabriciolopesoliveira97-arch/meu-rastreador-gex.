...
# CSS personalizado idêntico ao layout de referência
st.markdown("""
<style>
...
# Abas superiores
tab1, tab2 = st.tabs(["Sinais IA (1)", "Sinais Índices (0)"])

with tab1:
    st.markdown("<p style='color: #00ff88; font-size: 0.85em; font-weight: bold;'>⚡ Sinais Ativos (1)</p>", unsafe_allow_html=True)
    
    # Exibindo apenas o sinal do XAUUSD exatamente conforme a referência
    sinal_xau = {
